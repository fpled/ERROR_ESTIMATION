...
void calc_elem_vector_F_hat_enh( const TE &elem , const TM &m, const TF &f, const TTWW &vectors, const Vec<unsigned> &indices, const BV &flag_elem_enh, const TV &list_elems_enh, TV &nb_unk_local_enh, TTVVV &F_hat_enh ) {}

struct Calcul_Elem_Vector_F_hat_enh {
    const Vec<bool>* flag_elem_enh;
    const Vec<unsigned>* list_elems_enh;
    ...
    template<class TE, class TM, class TF, class T> void operator()( const TE &elem, const TM &m, const TF &f, Vec< Vec< Vec<T> > > &F_hat_enh ) const {
        ...
        calc_elem_vector_F_hat_enh( elem, m, f, f.vectors, ind, *flag_elem_enh, *list_elems_enh, *nb_unk_local_enh, F_hat_enh );
    }
};
...
void calc_elem_matrix_A_enh( const TE &elem , const TM &m, const TF &f, const BV &flag_elem_enh, const TV &list_elems_enh, const TTVVV &dep_hat_enh, TTMV &A_local_enh ) {}
...
struct Calcul_Elem_Matrix_A_enh {
    ...
    template<class TE, class TM, class TF> void operator()( const TE &elem, const TM &m, const TF &f, Vec< Mat<T, Gen<>, SparseLine<> > > &A_local_enh ) const {
        calc_elem_matrix_A_enh( elem, m, f, *flag_elem_enh, *list_elems_enh, *dep_hat_enh, A_local_enh );
    }
};
...
void calc_elem_vector_d_enh( const TE &elem , const TM &m, const TF &f, const BV &flag_elem_enh, const TV &list_elems_enh, const TTVV &dep_hat, const TTVVV &dep_hat_enh, const TTWW &vectors, const Vec<unsigned> &indices, TTVV &d_local_enh ) {}
...
struct Calcul_Elem_Vector_d_enh {
    ...
    template<class TE, class TM, class TF> void operator()( const TE &elem, const TM &m, const TF &f, Vec< Vec<T> > &d_local_enh ) const {
        Vec<unsigned,TE::nb_nodes+1+TF::nb_global_unknowns> ind = f.indices_for_element( elem );
        calc_elem_vector_d_enh( elem, m, f, *flag_elem_enh, *list_elems_enh, *dep_hat, *dep_hat_enh, f.vectors, ind, d_local_enh );
    }
};
...
void calc_elem_matrix_L_enh( const TE &elem , const TM &m, const TF &f, const BV &flag_face_enh, const BV &flag_elem_bal, const TV &list_elems_bal, TV &nb_unk_local_bal, TV &nb_eq_f_vol_local_enh, TTMV &L_local_enh ) {}

struct Calcul_Elem_Matrix_L_enh {
    const Vec<bool>* flag_face_enh;
    const Vec<bool>* flag_elem_bal;
    const Vec<unsigned>* list_elems_bal;
    ...
    template<class TE, class TM, class TF, class T> void operator()( const TE &elem, const TM &m, const TF &f, Vec< Mat<T, Gen<>, SparseLine<> > > &L_local_enh ) const {
        calc_elem_matrix_L_enh( elem, m, f, *flag_face_enh, *flag_elem_bal, *list_elems_bal, *nb_unk_local_bal, *nb_eq_f_vol_local_enh, L_local_enh );
    }
};
...
void calc_elem_vector_b_enh( const TE &elem , const TM &m, const TF &f, const TVV &list_nodes_face, const TV &cpt_elems_node, const TTVVV &vec_force_fluxes, const BV &flag_elem_bal, const TV &list_elems_bal, TTVV &b_local_enh ) {}
...
struct Calcul_Elem_Vector_b_enh {
    ...
    template<class TE, class TM, class TF> void operator()( const TE &elem, const TM &m, const TF &f, Vec< Vec<T> > &b_local_enh ) const {
        calc_elem_vector_b_enh( elem, m, f, *list_nodes_face, *cpt_elems_node, *vec_force_fluxes, *flag_elem_bal, *list_elems_bal, b_local_enh );
    }
};
...
void calc_glob_matrix_A_enh( const TE &elem , const TM &m, const TVV &list_nodes_face, const BV &flag_elem_enh, const TV &list_elems_enh, const TV &list_faces_enh, const TTMV &A_local_enh, TTM &A_enh ) {}

struct Calcul_Global_Matrix_A_enh {
    const Vec< Vec<unsigned> >* list_nodes_face;
    const Vec<bool>* flag_elem_enh;
    const Vec<unsigned>* list_elems_enh;
    const Vec<unsigned>* list_faces_enh;
    template<class TE, class TM, class T> void operator()( const TE &elem, const TM &m, const Vec< Mat<T, Gen<>, SparseLine<> > > &A_local_enh, Mat<T, Gen<>, SparseLine<> > &A_enh ) const {
        calc_glob_matrix_A_enh( elem, m, *list_nodes_face, *flag_elem_enh, *list_elems_enh, *list_faces_enh, A_local_enh, A_enh );
    }
};
...
void calc_glob_vector_d_enh( const TE &elem , const TM &m, const TVV &list_nodes_face, const BV &flag_elem_enh, const TV &list_elems_enh, const TV &list_faces_enh, const TTVV &d_local_enh, TTV &d_enh ) {}
...
struct Calcul_Global_Vector_d_enh {
    ...
    template<class TE, class TM, class T> void operator()( const TE &elem, const TM &m, const Vec< Vec<T> > &d_local_enh, Vec<T> &d_enh ) const {
        calc_glob_vector_d_enh( elem, m, *list_nodes_face, *flag_elem_enh, *list_elems_enh, *list_faces_enh, d_local_enh, d_enh );
    }
};
...
///-----------------------------------------
template<class TE, class TM, class TVV, class BV, class TV, class TTMV, class TTM>
void calc_glob_matrix_L_enh( const TE &elem , const TM &m, const TVV &list_nodes_face, const BV &flag_elem_bal, const TV &list_elems_bal, const BV &flag_face_enh, const TV &list_faces_enh, const TV &nb_eq_f_vol_local_enh, const TTMV &L_local_enh, TTM &L_enh ) {}
...
struct Calcul_Global_Matrix_L_enh {
    ...
    template<class TE, class TM, class T> void operator()( const TE &elem, const TM &m, const Vec< Mat<T, Gen<>, SparseLine<> > > &L_local_enh, Mat<T, Gen<>, SparseLine<> > &L_enh ) const {
        calc_glob_matrix_L_enh( elem, m, *list_nodes_face, *flag_elem_bal, *list_elems_bal, *flag_face_enh, *list_faces_enh, *nb_eq_f_vol_local_enh, L_local_enh, L_enh );
    }
};
...
void calc_glob_vector_b_enh( const TE &elem , const TM &m, const BV &flag_elem_bal, const TV &list_elems_bal, const TV &nb_eq_f_vol_local_enh, const TTVV &b_local_enh, TTV &b_enh ) {}
...
struct Calcul_Global_Vector_b_enh {
    ...
    template<class TE, class TM, class T> void operator()( const TE &elem, const TM &m, const Vec< Vec<T> > &b_local_enh, Vec<T> &b_enh ) const {
        calc_glob_vector_b_enh( elem, m, *flag_elem_bal, *list_elems_bal, *nb_eq_f_vol_local_enh, b_local_enh, b_enh );
    }
};
...
void calc_glob_matrix_C_enh( const TE &child_elem , const TVV &type_face, const BV &flag_face_enh, const TV &list_faces_enh, T &cpt_eq_f_surf_enh, TTM &C_enh ) {}
...
struct Calcul_Global_Matrix_C_enh {
    ...
    template<class TE, class T> void operator()( const TE &child_elem, unsigned &cpt_eq_f_surf_enh, Mat<T, Gen<>, SparseLine<> > &C_enh ) const {
        calc_glob_matrix_C_enh( child_elem, *type_face, *flag_face_enh, *list_faces_enh, cpt_eq_f_surf_enh, C_enh );
    }
};
...
void calc_glob_vector_q_enh( const TE &elem , const TM &m, const TF &f, const TVV &type_face, const TTWW &vectors, const Vec<unsigned> &indices, const BV &flag_elem_enh, T cpt_eq_f_surf_enh, TTV &q_enh ) {}
...
struct Calcul_Global_Vector_q_enh {
    ...
    template<class TE, class TM, class TF, class T> void operator()( const TE &elem, const TM &m, const TF &f, Vec<T> &q_enh ) const {
        Vec<unsigned,TE::nb_nodes+1+TF::nb_global_unknowns> ind = f.indices_for_element( elem );
        calc_glob_vector_q_enh( elem, m, f, *type_face, f.vectors, ind, *flag_elem_enh, *cpt_eq_f_surf_enh, q_enh );
    }
};
...
void calc_glob_matrix_P_enh( const TE &child_elem, const BV &flag_face_enh, const TV &list_faces_enh, T &cpt_eq_proj_f_surf_enh, TTM &P_enh ) {}
...
struct Calcul_Global_Matrix_P_enh {
    ...
    template<class TE, class T> void operator()( const TE &child_elem, unsigned &cpt_eq_proj_f_surf_enh, Mat<T, Gen<>, SparseLine<> > &P_enh ) const {
        calc_glob_matrix_P_enh( child_elem, *flag_face_enh, *list_faces_enh, cpt_eq_proj_f_surf_enh, P_enh );
    }
};
