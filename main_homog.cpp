...
int main( int argc, char **argv ) {
    ...
    static const string method = "EESPT"; //methode de construction de champs admissibles pour le pb direct : EET, SPET, EESPT
    static const string method_adjoint = "EET_SPET_EESPT"; // methode de construction de champs admissibles pour le pb adjoint : EET, SPET, EESPT
