...
//
// Description: calcul d'un champ de contrainte admissible et d'un estimateur de l'erreur globale pour les methodes basees sur la condition de prolongement (EET,EESPT)
//
//
...
void calcul_error_estimate_prolongation_condition( TM &m, const TF &f, const string &pb, T &theta, TV &theta_elem, const TVV &dep_hat, const bool want_global_discretization_error = false, const bool want_local_discretization_error = false, const bool disp = false ) {
