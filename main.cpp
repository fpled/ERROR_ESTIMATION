...
int main( int argc, char **argv ) {
    ...
    static const bool spread_cut_remesh = false; // propagation du raffinement au reste du maillage (étendue de la coupe si l'arête coupée n'est pas la plus longue de l'élément)
